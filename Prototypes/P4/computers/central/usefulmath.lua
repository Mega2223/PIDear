...
function calculateDerivatives(previousPosition,currentPosition,previousRotation,currentRotation)
	return {
		x = currentPosition.x - previousPosition.x,
		y = currentPosition.y - previousPosition.y,
		z = currentPosition.z - previousPosition.z
	},{
		roll = currentRotation.roll - previousRotation.roll,
		pitch = currentRotation.pitch - previousRotation.pitch,
		yaw = currentRotation.yaw - previousRotation.yaw
	}
end
